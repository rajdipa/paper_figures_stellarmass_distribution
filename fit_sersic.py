...
def config_params(rad, rho, err, min_r=6.0, max_r=120.0,
    ...
    if param_config is None:
        ...
        param_config = {
            'n': {
                'name': 'n', 'label':r'$n_{\rm Ser}$', 'ini': 4.0,
                'min': 1.0, 'max': 14.0, 'type': 'flat', 'sig': 1.0
            },
            'I0': {
...
def update_params(pbest, pcov, nsig=5.0):
    ...
    param_config = {
        'n': {
            ...
            'min': pbest[0] - nsig * perr[0], 'max': pbest[0] + 3* nsig * perr[0],
        ...
        'Re': {
            ...
            'min': pbest[2] - nsig * perr[2], 'max': pbest[2] + 2* nsig * perr[2],
